...
test.describe('Head tag area', () => {
    test('Contains the Head tag and its contents', async ({ page}) => {
        ...
        const metaDiscription =  page.locator('meta[name="description"]');
        await expect(metaDiscription).toHaveAttribute('content', 'Generated by create next app')
...
test.describe('Main content tests', () => {
    test('Should contain a heading welcome to my home page', async ({ page }) =>{
        await page.goto(homePage);
        await expect(page.locator('h1')).toContainText("Welcome to my cloud")
    })
